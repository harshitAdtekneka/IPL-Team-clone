...
public class MyApplication extends Application implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    public String prefName = "IPLSchedule";
    ...
    public class AppOpenAdManager {
        ...
        private void loadAd(final Context context) {
            ...
            AppOpenAd.load(
                    context,
                    getStringData(Constants.Pref_AppOpenId),
                    request,
    ...
    /*private class ExampleNotificationOpenedHandler implements OneSignal.NotificationOpenedHandler {
        ...
        public void notificationOpened(OSNotificationOpenResult result) {
            ...
            customTabsIntent.launchUrl(mInstance, Uri.parse(BuildConfig.QUREKA_URL));
        }
    }
*/
    ...
    public void setBooleanData(String Key, boolean flag) {
