...
public class TestFragment extends Fragment implements View.OnClickListener, IntentOnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.cv_batting:
                PopUpAdsFull.showInterstitialAds(myApplication, getActivity(), this, "test", 0);
                break;

            case R.id.cv_bowling:
                PopUpAdsFull.showInterstitialAds(myApplication, getActivity(), this, "test", 1);
                break;

            case R.id.cv_fielding:
                PopUpAdsFull.showInterstitialAds(myApplication, getActivity(), this, "test", 2);
                break;

            case R.id.cv_other:
                PopUpAdsFull.showInterstitialAds(myApplication, getActivity(), this, "test", 3);
                break;
