...
public class ODFragment extends Fragment implements View.OnClickListener, IntentOnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.cv_batting:
                PopUpAdsFull.showInterstitialAds(myApplication, getActivity(), this, "od", 0);
                break;

            case R.id.cv_bowling:
                PopUpAdsFull.showInterstitialAds(myApplication, getActivity(), this, "od", 1);
                break;

            case R.id.cv_fielding:
                PopUpAdsFull.showInterstitialAds(myApplication, getActivity(), this, "od", 2);
                break;
